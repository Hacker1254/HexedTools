...
namespace Iced.Intel.DecoderInternal {
	static partial class OpCodeHandlersTables_EVEX {
		...
		const int MaxIdNames = 10;
		const uint Handlers_0FIndex = 9;
		const uint Handlers_0F38Index = 5;
		const uint Handlers_0F3AIndex = 6;
		const uint Handlers_MAP5Index = 7;
		const uint Handlers_MAP6Index = 8;
	}
}
#endif
